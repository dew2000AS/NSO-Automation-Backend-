...
@Getter
@Setter
@Table(name = "tmp_tariff", indexes = {  // Points to tmp_tariff table (draft/working)
    @Index(name = "idx_tmp_rate_status", columnList = "rate_status"),
    @Index(name = "idx_tmp_record_status", columnList = "record_status"),
    @Index(name = "idx_tmp_dates", columnList = "from_date, to_date")
})
